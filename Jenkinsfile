...
node("android"){
  ...
  stage ("Prepare"){
    ...
    if (params.BUILD_CONFIG == 'release') {
      sh './gradlew clean compileDebugSources' // builds app/build/outputs/apk/app-release.apk file
    } else {
      sh './gradlew clean compileReleaseSources' // builds app/build/outputs/apk/app-debug.apk
    }
  }
